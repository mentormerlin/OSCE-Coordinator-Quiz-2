...
function sendResultToSheet(result) {
    const scriptURL = 'https://script.google.com/macros/s/AKfycbz470VtU6D1LJkGlbLuDgfBpU6Ps6tV0Egy8450Q49MoObjcrFtvpmxDuvdFhTMuqXr/exec';
    if (!scriptURL) return;
...
function fetchLeaderboardData() {
    return new Promise((resolve, reject) => {
        const readURL = 'https://script.google.com/macros/s/AKfycbz470VtU6D1LJkGlbLuDgfBpU6Ps6tV0Egy8450Q49MoObjcrFtvpmxDuvdFhTMuqXr/exec?action=get';
        if (!readURL) {
            reject();
            return;
        }
